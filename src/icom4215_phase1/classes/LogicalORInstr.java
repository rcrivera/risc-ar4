...
/**
 * @author Eddrick
 *Class that execute logical OR instruction.
 */
public class LogicalORInstr implements Instruction{
	 ...
	 * Construction
	 */
	public LogicalORInstr(String acumulator, String register) {
	...
	public void execute() {
		...
		while(acumCounter < 8 && registerCounter < 8){
			...
			if(acumBit.equals('1') || registerBit.equals('1')){
				temp = temp.concat("1");
			}
			else{
				temp = temp.concat("0");
